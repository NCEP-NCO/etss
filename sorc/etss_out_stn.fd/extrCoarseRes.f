      SUBROUTINE extrCoarseRes (area,Spinup)
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
!c
!c    PURPOSE:
!c       ARCHIVE HOURLY SURGE VALUES FROM THE MODEL AND GENERATE FORMAT OUTPUT
!c       BY USING EXTRA-TOPICAL BASIN OUTPUTS
!c
!c    ARGUMENTS:
!c
!c    INPUT FILES:
...
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      CHARACTER*96 TTL3_2
      CHARACTER*1 AAA
      CHARACTER*255 FIL_96,FIL_11,FIL_16,FIL_17,FIL_58,FIL_59
...
!         IF(ITIME.GE.96) THEN
!         IF(ITIME.GE.Spinup*2) THEN
         IF(ITIME.GE.Spinup) THEN
...
!c Only need output west coastal station from Nep basins
!      if (area == 'n')then
!         npts=26
!         npts2=57
!      endif
...
!c      WRITE(58,1000) (IHIS(J,I),I=98,103)
 400  CONTINUE
      DO  J=1,NPTS2
