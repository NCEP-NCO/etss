...
# ###############################
   ...
   echo ${IDATE:0:4} >> HSBY
# ###############################
# Get water level obs BUFR files
# ###############################
   touch TEST
...
if [[ ${RANK} == 1 ]] ; then
   ...
   for i in `seq 5 -1 0` ; do
       ...
       if [ -s ${bufrTank}/xx012 ] ; then
         ...
         msg="$job Warning: The bufr ${bufrTank}/xx012 is missing or 0-bytes"
         postmsg "$jlogfile" "$msg"
       fi
    done
   ...
   for i in `seq 5 -1 0` ; do
       ...
       if [ -s ${bufrTank}/xx005 ] ; then
          ...
          msg="$job Warning: The bufr ${bufrTank}/xx005 is missing or 0-bytes"
          postmsg "$jlogfile" "$msg"
       fi
    done
  ...
  if [[ $i -eq 5 ]] ; then
    ...
    for HH in "${hrs[@]:${ind}:4}" ; do
      ...
      for bsn in "${bsns[@]}" ; do
          ...
          if [ -s ${COMIN}/etss.${PDYmx}/etss.t${HH}z.stormsurge.${bsn}.txt ] ; then
              cat ${COMIN}/etss.${PDYmx}/etss.t${HH}z.stormsurge.${bsn}.txt >> ${PDYmx}_${HH}.ss
          else
              msg="$job Warning: The surge file ${COMIN}/etss.${PDYmx}/etss.t${HH}z.stormsurge.${bsn}.txt is missing or 0-bytes"
              postmsg "$jlogfile" "$msg"
          fi
      done
    done
...
export pgm=etss_post_debufr
if [[ ${RANK} == 0 ]] ; then
   if [ -s ${PDY}.shef12 ]; then
      startmsg
      ${EXECetss}/etss_post_debufr ${PDY}.shef12 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
      ${EXECetss}/etss_post_debufr ${PDY}.shef13 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
   ...
   if [ -s ${PDYm1}.shef12 ]; then
      startmsg
      ${EXECetss}/etss_post_debufr ${PDYm1}.shef12 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
      ${EXECetss}/etss_post_debufr ${PDYm1}.shef13 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
   ...
   if [ -s ${PDYm2}.shef12 ]; then
      startmsg
      ${EXECetss}/etss_post_debufr ${PDYm2}.shef12 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
      ${EXECetss}/etss_post_debufr ${PDYm2}.shef13 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
   ...
   if [ -s ${PDYm3}.shef12 ]; then
      startmsg
      ${EXECetss}/etss_post_debufr ${PDYm3}.shef12 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
      ${EXECetss}/etss_post_debufr ${PDYm3}.shef13 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
   ...
   if [ -s ${PDYm4}.shef12 ]; then
      startmsg
      ${EXECetss}/etss_post_debufr ${PDYm4}.shef12 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
      ${EXECetss}/etss_post_debufr ${PDYm4}.shef13 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
   ...
   if [ -s ${PDYm5}.shef12 ]; then
      startmsg
      ${EXECetss}/etss_post_debufr ${PDYm5}.shef12 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
      ${EXECetss}/etss_post_debufr ${PDYm5}.shef13 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
  ...
  touch filler.ss
   ...
   if [ -s ${PDY}.shef05 ]; then
      startmsg
      ${EXECetss}/etss_post_debufr ${PDY}.shef05 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
      cpreq out/${PDY}.shef05 $COMOUT 
   ...
   if [ -s ${PDYm1}.shef05 ]; then
      startmsg
      ${EXECetss}/etss_post_debufr ${PDYm1}.shef05 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
      cpreq out/${PDYm1}.shef05 $COMOUT 
   ...
   if [ -s ${PDYm2}.shef05 ]; then
      startmsg 
      ${EXECetss}/etss_post_debufr ${PDYm2}.shef05 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk
      cpreq out/${PDYm2}.shef05 $COMOUT 
   ...
   if [ -s ${PDYm3}.shef05 ]; then
      startmsg  
      ${EXECetss}/etss_post_debufr ${PDYm3}.shef05 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk 
      cpreq out/${PDYm3}.shef05 $COMOUT 
   ...
   if [ -s ${PDYm4}.shef05 ]; then
      startmsg  
      ${EXECetss}/etss_post_debufr ${PDYm4}.shef05 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk 
      cpreq out/${PDYm4}.shef05 $COMOUT 
   ...
   if [ -s ${PDYm5}.shef05 ]; then
      startmsg   
      ${EXECetss}/etss_post_debufr ${PDYm5}.shef05 >> $pgmout 2> errfile_${RANK}
      err=$?;export err; err_chk  
      cpreq out/${PDYm5}.shef05 $COMOUT 
